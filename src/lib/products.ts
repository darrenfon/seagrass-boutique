...
const trendingProducts: Product[] = [
  ...
  { handle: "fiesta-flora-maxi-dress", title: "Fiesta Flora Maxi Dress", vendor: "Lost + Wander", price: 108, color: "Multicolor", category: "dresses", collections: ["trending"], tags: ["dress", "maxi", "floral"], image: colorGradient("Multicolor"), realImage: "/images/products/fiesta-flora-maxi-dress.jpg" },
...
const springProducts: Product[] = [
  ...
  { handle: "dewy-cardigan", title: "Dewy Cardigan", vendor: "Sage the Label", price: 90, color: "Multicolor", category: "clothing", collections: ["spring-fashion"], tags: ["cardigan", "knit"], image: colorGradient("Multicolor"), realImage: "/images/products/dewy-cardigan.jpg" },
  { handle: "lily-pond-midi-skirt", title: "Lily Pond Midi Skirt", vendor: "Sage the Label", price: 115, color: "White", category: "clothing", collections: ["spring-fashion"], tags: ["skirt", "midi"], image: colorGradient("White"), realImage: "/images/products/lily-pond-midi-skirt.jpg" },
  { handle: "tia-contour-zip-blouse", title: "Tia Contour Zip Blouse", vendor: "Vava by Joy Hahn", price: 85, color: "Green", category: "clothing", collections: ["spring-fashion"], tags: ["blouse", "zip"], image: colorGradient("Green"), realImage: "/images/products/tia-contour-zip-blouse.jpg" },
  { handle: "saylor-flutter-sleeve-sweater", title: "Saylor Flutter Sleeve Sweater", vendor: "Design History", price: 135, color: "Multicolor", category: "clothing", collections: ["spring-fashion"], tags: ["sweater", "flutter-sleeve"], image: colorGradient("Multicolor"), realImage: "/images/products/saylor-flutter-sleeve-sweater.jpg" },
  { handle: "sailor-dress", title: "Sailor Dress", vendor: "Vava by Joy Hahn", price: 120, color: "Blue", category: "dresses", collections: ["spring-fashion"], tags: ["dress", "nautical"], image: colorGradient("Blue"), realImage: "/images/products/sailor-dress.jpg" },
  { handle: "perla-sweater", title: "Perla Sweater", vendor: "Rain + Rose", price: 98, color: "Multicolor", category: "clothing", collections: ["spring-fashion"], tags: ["sweater"], image: colorGradient("Multicolor"), realImage: "/images/products/perla-sweater.jpg" },
  { handle: "samara-cardigan", title: "Samara Cardigan", vendor: "Rain + Rose", price: 98, color: "Blue", category: "clothing", collections: ["spring-fashion"], tags: ["cardigan"], image: colorGradient("Blue"), realImage: "/images/products/samara-cardigan.jpg" },
  { handle: "coralie-sweater", title: "Coralie Sweater", vendor: "Rain + Rose", price: 98, color: "Multicolor", category: "clothing", collections: ["spring-fashion"], tags: ["sweater"], image: colorGradient("Multicolor"), realImage: "/images/products/coralie-sweater.jpg" },
  { handle: "frayed-cropped-flare", title: "Frayed Cropped Flare", vendor: "Just Black Denim", price: 108, color: "Black", category: "clothing", collections: ["spring-fashion"], tags: ["jeans", "flare", "denim"], image: colorGradient("Black"), realImage: "/images/products/frayed-cropped-flare.jpg" },
  { handle: "marla-ruffle-dress", title: "Marla Ruffle Dress", vendor: "Seagrass Boutique", price: 72, color: "Multicolor", category: "dresses", collections: ["spring-fashion"], tags: ["dress", "ruffle"], image: colorGradient("Multicolor"), realImage: "/images/products/marla-ruffle-dress.jpg" },
  { handle: "mirabel-blouse", title: "Mirabel Blouse", vendor: "Lovestitch", price: 52, color: "Multicolor", category: "clothing", collections: ["spring-fashion"], tags: ["blouse"], image: colorGradient("Multicolor"), realImage: "/images/products/mirabel-blouse.jpg" },
  { handle: "jaden-mineral-wash-pant", title: "Jaden Mineral Wash Cropped Pant", vendor: "Michael Stars", price: 168, color: "Caper", category: "clothing", collections: ["spring-fashion"], tags: ["pants", "cropped"], image: colorGradient("Caper"), realImage: "/images/products/jaden-mineral-wash-pant.jpg" },
  { handle: "marlow-mineral-wash-cardigan", title: "Marlow Mineral Wash Cardigan", vendor: "Michael Stars", price: 158, color: "Caper", category: "clothing", collections: ["spring-fashion"], tags: ["cardigan"], image: colorGradient("Caper"), realImage: "/images/products/marlow-mineral-wash-cardigan.jpg" },
  { handle: "kaylie-top", title: "Kaylie Top", vendor: "DH New York", price: 158, color: "Tan", category: "clothing", collections: ["spring-fashion"], tags: ["top"], image: colorGradient("Tan"), realImage: "/images/products/kaylie-top.jpg" },
  { handle: "hr-tonal-crop-flare", title: "HR Tonal Crop Flare", vendor: "Just Black Denim", price: 108, color: "Blue", category: "clothing", collections: ["spring-fashion"], tags: ["jeans", "flare", "denim"], image: colorGradient("Blue"), realImage: "/images/products/hr-tonal-crop-flare.jpg" },
  { handle: "abigail-stripe-sweater", title: "Abigail Stripe Sweater", vendor: "Sage the Label", price: 100, color: "Multicolor", category: "clothing", collections: ["spring-fashion"], tags: ["sweater", "stripe"], image: colorGradient("Multicolor"), realImage: "/images/products/abigail-stripe-sweater.jpg" },
  { handle: "deja-vu-bubble-maxi-skirt", title: "Deja Vu Bubble Maxi Skirt", vendor: "Sage the Label", price: 90, color: "White", category: "clothing", collections: ["spring-fashion"], tags: ["skirt", "maxi"], image: colorGradient("White"), realImage: "/images/products/deja-vu-bubble-maxi-skirt.jpg" },
  { handle: "fountain-open-back-sweater", title: "Fountain Open Back Sweater", vendor: "Sage the Label", price: 85, color: "Blue", category: "clothing", collections: ["spring-fashion"], tags: ["sweater", "open-back"], image: colorGradient("Blue"), realImage: "/images/products/fountain-open-back-sweater.jpg" },
  { handle: "precious-knit-top", title: "Precious Knit Top", vendor: "Sage the Label", price: 110, color: "White", category: "clothing", collections: ["spring-fashion"], tags: ["top", "knit"], image: colorGradient("White"), realImage: "/images/products/precious-knit-top.jpg" },
];
...
const shoesProducts: Product[] = [
  { handle: "isla-woven-sandal", title: "Isla Woven Sandal", vendor: "Seagrass Boutique", price: 78, color: "Tan", category: "shoes", collections: [], tags: ["sandal", "woven"], image: colorGradient("Tan"), realImage: "/images/products/isla-woven-sandal.jpg" },
  { handle: "marina-slide", title: "Marina Slide", vendor: "Seagrass Boutique", price: 65, color: "White", category: "shoes", collections: [], tags: ["slide", "casual"], image: colorGradient("White"), realImage: "/images/products/marina-slide.jpg" },
  { handle: "coastline-espadrille", title: "Coastline Espadrille Wedge", vendor: "Seagrass Boutique", price: 95, color: "Tan", category: "shoes", collections: [], tags: ["espadrille", "wedge"], image: colorGradient("Tan"), realImage: "/images/products/coastline-espadrille.jpg" },
  { handle: "driftwood-platform", title: "Driftwood Platform Sandal", vendor: "Seagrass Boutique", price: 88, color: "Black", category: "shoes", collections: [], tags: ["platform", "sandal"], image: colorGradient("Black"), realImage: "/images/products/driftwood-platform.jpg" },
  { handle: "shoreline-flat", title: "Shoreline Braided Flat", vendor: "Seagrass Boutique", price: 72, color: "Tan", category: "shoes", collections: [], tags: ["flat", "braided"], image: colorGradient("Tan"), realImage: "/images/products/shoreline-flat.jpg" },
  { handle: "sunset-mule", title: "Sunset Mule", vendor: "Seagrass Boutique", price: 85, color: "Pink", category: "shoes", collections: [], tags: ["mule"], image: colorGradient("Pink"), realImage: "/images/products/sunset-mule.jpg" },
];

const accessoriesProducts: Product[] = [
  { handle: "tide-pool-earrings", title: "Tide Pool Drop Earrings", vendor: "Seagrass Boutique", price: 38, color: "Blue", category: "accessories", collections: [], tags: ["earrings", "jewelry"], image: colorGradient("Blue"), realImage: "/images/products/tide-pool-earrings.jpg" },
  { handle: "shell-pendant-necklace", title: "Shell Pendant Necklace", vendor: "Seagrass Boutique", price: 48, color: "White", category: "accessories", collections: [], tags: ["necklace", "jewelry"], image: colorGradient("White"), realImage: "/images/products/shell-pendant-necklace.jpg" },
  { handle: "dune-woven-tote", title: "Dune Woven Tote", vendor: "Seagrass Boutique", price: 68, color: "Tan", category: "accessories", collections: [], tags: ["tote", "bag", "woven"], image: colorGradient("Tan"), realImage: "/images/products/dune-woven-tote.jpg" },
  { handle: "ocean-mist-scarf", title: "Ocean Mist Silk Scarf", vendor: "Seagrass Boutique", price: 55, color: "Blue", category: "accessories", collections: [], tags: ["scarf", "silk"], image: colorGradient("Blue"), realImage: "/images/products/ocean-mist-scarf.jpg" },
  { handle: "boardwalk-sunglasses", title: "Boardwalk Oversized Sunglasses", vendor: "Seagrass Boutique", price: 42, color: "Black", category: "accessories", collections: [], tags: ["sunglasses"], image: colorGradient("Black"), realImage: "/images/products/boardwalk-sunglasses.jpg" },
  { handle: "coral-cuff-bracelet", title: "Coral Cuff Bracelet", vendor: "Seagrass Boutique", price: 35, color: "Pink", category: "accessories", collections: [], tags: ["bracelet", "jewelry"], image: colorGradient("Pink"), realImage: "/images/products/coral-cuff-bracelet.jpg" },
];
