...
const voluspaProducts: Product[] = [
  { handle: "mediterranean-lemon-classic", title: "Mediterranean Lemon - Classic Candle", vendor: "Voluspa", price: 34, color: "Yellow", category: "candles", collections: ["voluspa"], tags: ["candle", "classic", "citrus"], image: colorGradient("Yellow") },
  { handle: "foraged-wildberry-classic", title: "Foraged Wildberry - Classic Candle", vendor: "Voluspa", price: 34, color: "Multicolor", category: "candles", collections: ["voluspa"], tags: ["candle", "classic", "berry"], image: colorGradient("Multicolor") },
  { handle: "foraged-wildberry-large-jar", title: "Foraged Wildberry - Large Jar Candle", vendor: "Voluspa", price: 38, color: "Multicolor", category: "candles", collections: ["voluspa"], tags: ["candle", "large-jar", "berry"], image: colorGradient("Multicolor") },
  { handle: "jasmine-midnight-blooms-classic", title: "Jasmine Midnight Blooms - Classic Candle", vendor: "Voluspa", price: 34, color: "White", category: "candles", collections: ["voluspa"], tags: ["candle", "classic", "floral"], image: colorGradient("White") },
  { handle: "forbidden-fig-classic", title: "Forbidden Fig - Classic Candle", vendor: "Voluspa", price: 34, color: "Green", category: "candles", collections: ["voluspa"], tags: ["candle", "classic", "fig"], image: colorGradient("Green") },
  { handle: "forbidden-fig-large-jar", title: "Forbidden Fig - Large Jar Candle", vendor: "Voluspa", price: 38, color: "Green", category: "candles", collections: ["voluspa"], tags: ["candle", "large-jar", "fig"], image: colorGradient("Green") },
  { handle: "milk-rose-textured", title: "Milk Rose - Textured Glass Candle", vendor: "Voluspa", price: 30, color: "Pink", category: "candles", collections: ["voluspa"], tags: ["candle", "textured-glass", "rose"], image: colorGradient("Pink") },
  { handle: "milk-rose-large-jar", title: "Milk Rose - Large Jar Candle", vendor: "Voluspa", price: 45, color: "Pink", category: "candles", collections: ["voluspa"], tags: ["candle", "large-jar", "rose"], image: colorGradient("Pink") },
  { handle: "rose-otto-textured", title: "Rose Otto - Textured Glass Candle", vendor: "Voluspa", price: 30, color: "Pink", category: "candles", collections: ["voluspa"], tags: ["candle", "textured-glass", "rose"], image: colorGradient("Pink") },
  { handle: "rose-otto-large-jar", title: "Rose Otto - Large Glass Jar", vendor: "Voluspa", price: 45, color: "Pink", category: "candles", collections: ["voluspa"], tags: ["candle", "large-jar", "rose"], image: colorGradient("Pink") },
  { handle: "blackberry-rose-oud-textured", title: "Blackberry Rose Oud - Textured Glass Candle", vendor: "Voluspa", price: 30, color: "Multicolor", category: "candles", collections: ["voluspa"], tags: ["candle", "textured-glass", "oud"], image: colorGradient("Multicolor") },
  { handle: "blackberry-rose-oud-large-jar", title: "Blackberry Rose Oud - Large Jar Candle", vendor: "Voluspa", price: 45, color: "Multicolor", category: "candles", collections: ["voluspa"], tags: ["candle", "large-jar", "oud"], image: colorGradient("Multicolor") },
  { handle: "rose-petal-ice-cream-textured", title: "Rose Petal Ice Cream - Textured Glass Candle", vendor: "Voluspa", price: 30, color: "Pink", category: "candles", collections: ["voluspa"], tags: ["candle", "textured-glass"], image: colorGradient("Pink") },
  { handle: "rose-petal-ice-cream-large-jar", title: "Rose Petal Ice Cream - Large Jar Candle", vendor: "Voluspa", price: 45, color: "Pink", category: "candles", collections: ["voluspa"], tags: ["candle", "large-jar"], image: colorGradient("Pink") },
  { handle: "rose-colored-glasses-textured", title: "Rose Colored Glasses - Textured Glass Candle", vendor: "Voluspa", price: 30, color: "Pink", category: "candles", collections: ["voluspa"], tags: ["candle", "textured-glass"], image: colorGradient("Pink") },
  { handle: "rose-colored-glasses-large-jar", title: "Rose Colored Glasses - Large Jar Candle", vendor: "Voluspa", price: 45, color: "Pink", category: "candles", collections: ["voluspa"], tags: ["candle", "large-jar"], image: colorGradient("Pink") },
  { handle: "mokara-classic", title: "Mokara - Classic Candle", vendor: "Voluspa", price: 34, color: "Pink", category: "candles", collections: ["voluspa"], tags: ["candle", "classic", "floral"], image: colorGradient("Pink") },
  { handle: "mokara-large-jar", title: "Mokara - Large Jar Candle", vendor: "Voluspa", price: 38, color: "Pink", category: "candles", collections: ["voluspa"], tags: ["candle", "large-jar", "floral"], image: colorGradient("Pink") },
  { handle: "goji-tarocco-orange-classic", title: "Goji Tarocco Orange - Classic Candle", vendor: "Voluspa", price: 34, color: "Yellow", category: "candles", collections: ["voluspa"], tags: ["candle", "classic", "citrus"], image: colorGradient("Yellow") },
  { handle: "goji-tarocco-orange-large-jar", title: "Goji Tarocco Orange - Large Jar Candle", vendor: "Voluspa", price: 38, color: "Yellow", category: "candles", collections: ["voluspa"], tags: ["candle", "large-jar", "citrus"], image: colorGradient("Yellow") },
];
...
const springProducts: Product[] = [
  { handle: "trish-zip-peplum-top", title: "Trish Zip Peplum Top", vendor: "Vava by Joy Hahn", price: 80, color: "Yellow", category: "clothing", collections: ["spring-fashion", "summer-fashion"], tags: ["top", "peplum"], image: colorGradient("Yellow") },
...
const summerProducts: Product[] = [
  { handle: "kelly-embroidered-mini-dress", title: "Kelly Embroidered Mini Dress", vendor: "Vava by Joy Hahn", price: 120, color: "Black", category: "dresses", collections: ["summer-fashion"], tags: ["dress", "mini", "embroidered"], image: colorGradient("Black") },
  { handle: "kelly-embroidered-smock-top", title: "Kelly Embroidered Smock Top", vendor: "Vava by Joy Hahn", price: 80, color: "Pink", category: "clothing", collections: ["summer-fashion"], tags: ["top", "embroidered"], image: colorGradient("Pink") },
  { handle: "sarah-embroidered-shirt", title: "Sarah Embroidered Shirt", vendor: "Design History", price: 90, color: "Blue", category: "clothing", collections: ["summer-fashion"], tags: ["shirt", "embroidered"], image: colorGradient("Blue") },
  { handle: "taylor-embroidered-short", title: "Taylor Embroidered Short", vendor: "Design History", price: 78, color: "Blue", category: "clothing", collections: ["summer-fashion"], tags: ["shorts", "embroidered"], image: colorGradient("Blue") },
  { handle: "pepper-eyelet-top", title: "Pepper Eyelet Top", vendor: "Lovestitch", price: 68, color: "Blue", category: "clothing", collections: ["summer-fashion"], tags: ["top", "eyelet"], image: colorGradient("Blue") },
  { handle: "laguna-short", title: "Laguna Short - Soft Blue Wash", vendor: "Hatley", price: 90, color: "Blue", category: "clothing", collections: ["summer-fashion"], tags: ["shorts", "denim"], image: colorGradient("Blue") },
  { handle: "bella-dress-soft-ikat", title: "Bella Dress - Soft Ikat", vendor: "Hatley", price: 95, color: "Blue", category: "dresses", collections: ["summer-fashion"], tags: ["dress", "ikat"], image: colorGradient("Blue") },
  { handle: "simone-knit-tee", title: "Simone Knit Tee - Navy & White Stripe", vendor: "Hatley", price: 90, color: "Multicolor", category: "clothing", collections: ["summer-fashion"], tags: ["tee", "stripe"], image: colorGradient("Multicolor") },
  { handle: "jasmine-knit-top", title: "Jasmine 3/4 Sleeve Knit Top", vendor: "Hatley", price: 90, color: "Blue", category: "clothing", collections: ["summer-fashion"], tags: ["top", "knit"], image: colorGradient("Blue") },
  { handle: "julia-shirt-dress", title: "Julia Shirt Dress", vendor: "Hatley", price: 140, color: "Multicolor", category: "dresses", collections: ["summer-fashion"], tags: ["dress", "shirt-dress", "stripe"], image: colorGradient("Multicolor") },
  { handle: "velora-tank", title: "Velora Tank", vendor: "Lovestitch", price: 48, color: "Teal", category: "clothing", collections: ["summer-fashion"], tags: ["tank", "basic"], image: colorGradient("Teal") },
  { handle: "sunset-promenade-mini-dress", title: "Sunset Promenade Mini Dress", vendor: "Lost + Wander", price: 88, color: "Multicolor", category: "dresses", collections: ["summer-fashion"], tags: ["dress", "mini"], image: colorGradient("Multicolor") },
  { handle: "sunset-promenade-top", title: "Sunset Promenade Top", vendor: "Lost + Wander", price: 68, color: "Multicolor", category: "clothing", collections: ["summer-fashion"], tags: ["top"], image: colorGradient("Multicolor") },
  { handle: "jenny-ruffle-sleeve-blouse", title: "Jenny Ruffle Sleeve Blouse", vendor: "Lovestitch", price: 56, color: "White", category: "clothing", collections: ["summer-fashion"], tags: ["blouse", "ruffle"], image: colorGradient("White") },
  { handle: "lace-embroidered-mini-dress", title: "Lace Embroidered Mini Dress", vendor: "Current Air", price: 98, color: "Multicolor", category: "dresses", collections: ["summer-fashion"], tags: ["dress", "mini", "lace"], image: colorGradient("Multicolor") },
  { handle: "eyelet-embroidered-shirt", title: "Eyelet Embroidered Shirt", vendor: "Current Air", price: 90, color: "White", category: "clothing", collections: ["summer-fashion"], tags: ["shirt", "eyelet"], image: colorGradient("White") },
  { handle: "straight-leg-pant", title: "Straight Leg Pant - Soft Blue Wash", vendor: "Hatley", price: 125, color: "Blue", category: "clothing", collections: ["summer-fashion"], tags: ["pants", "denim"], image: colorGradient("Blue") },
  { handle: "sadie-vneck-tee", title: "Sadie V-Neck Tee", vendor: "Hatley", price: 45, color: "Black", category: "clothing", collections: ["summer-fashion"], tags: ["tee", "basic"], image: colorGradient("Black") },
  { handle: "tencel-jacket", title: "Tencel Jacket", vendor: "Hatley", price: 150, color: "Blue", category: "clothing", collections: ["summer-fashion"], tags: ["jacket", "tencel"], image: colorGradient("Blue") },
];
